        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="breadcrumb text-center">
            <div class="section-headline white-headline">
              <h3>RECUPERA&Ccedil;&Atilde;O JUDICIAL</h3><br /><br /><br />
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="col-md-6">
      ...
      <?php do { ?>
        <div class="sm-display-block mt-sm-10 mb-sm-10">
          ...
          <a class="p-5 text-black font-17 pl-10 pr-10" href="recuperacoes-judiciais-detalhes.php?codigo=<?php echo $row_rsBusca['Id']; ?>"><strong><?php echo $row_rsBusca['empresa']; ?></strong></a>
        </div>
        <br />
